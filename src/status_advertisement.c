...
// Note: Layer event listener removed due to undefined symbols in current ZMK version
// Using polling approach in build_prospector_data() instead
...
// Note: Layer event listener removed due to undefined symbols
// Layer state is polled in build_prospector_data() instead
