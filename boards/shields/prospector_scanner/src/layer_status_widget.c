...
int zmk_widget_layer_status_init(struct zmk_widget_layer_status *widget, lv_obj_t *parent) {
    ...
    lv_obj_set_style_text_font(widget->layer_title, &lv_font_montserrat_16, 0); // Larger title font
    ...
    for (int i = 0; i < MAX_LAYER_DISPLAY; i++) {
        ...
        lv_obj_set_style_text_font(widget->layer_labels[i], &lv_font_montserrat_24, 0);
